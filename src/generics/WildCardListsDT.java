...
public class WildCardListsDT<T extends Number> { // Here the typr becomes specific and thus we cannot make an arraylist
    // a string type WHY? 'cause String is NOT A SUBCLASS OF NUMBER!
    ...
    static void main() {
        WildCardListsDT<Integer> list = new WildCardListsDT<>();
        list.add(56574);
        System.out.println(list);
//        WildCardListsDT<String> list2 = new WildCardListsDT<>();
//        list2.add("This is a string");
//        System.out.println(list2);
        // this gives an error cause we have specifically told the Type T to be a Number type
        // I can be a long an integer or a double or a floating type
    }
